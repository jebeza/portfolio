...
export default function App() {
  return (
    <main className="font-body min-h-screen bg-[#f3efef] px-6 md:px-12 py-10">
      {/* Grid */}
      <section
        className="
          grid gap-6
      ...
      >
        ...
        >
          <CardContent className="grid gap-6">
            <div>
              <img src="/avatar.png" alt="Jenifer" className="w-25 h-30"/>
            </div>
            <div>
              <p className="leading-7 letter-spacing-[0.5px] font-body text-lg">
                Soy <AuroraText className="text-4xl font-display">Jenifer</AuroraText>, desarrolladora
        ...
        >
          <CardContent className="text-center">
            <p className="text-8xl font-display">ES</p>
        ...
        >
          ...
          <div className="absolute -bottom-30 -right-60 w-122 h-98.25 bg-[#FAC2D7] rounded-full" />
        </Card>
        ...
        <Card
          ...
          "
        >
          <a href="mailto:jbenaventzapata@gmail.com" className="flex items-center justify-center">
            <SiMailboxdotorg size={90} className="text-[#62CBDB]" />
          </a>
        </Card>
        ...
        <Card
          className="
            rounded-3xl bg-[#FFA498] shadow-none
            flex items-center justify-center
        ...
        >
          ...
          <div className="absolute -top-90 -right-90 w-150.75 h-165.5 bg-[#FAC2D7] rounded-full" />
        </Card>

        {/* 7 — Tech stack */}
        <Card className="rounded-3xl bg-white shadow-none p-6 flex items-center justify-center xl:col-start-1 xl:col-span-2 xl:row-start-3">
          <TechGrid />
        </Card>
